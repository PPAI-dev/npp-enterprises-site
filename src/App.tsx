    ...
    <div className="min-h-screen gritty-overlay">
      ...
      <section id="hero" className="relative min-h-[90vh] flex items-center pt-48 pb-32 overflow-hidden">
        <div className="absolute inset-0">
          <img src={IMAGES.hero} alt="NPP Enterprises Project" className="w-full h-full object-cover" />
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="flex items-center space-x-4 border-r border-slate-100 last:border-0 pr-8">
              ...
              <div><p className="text-brand-dark font-display font-black text-2xl tracking-tighter leading-none uppercase italic">25+ Years</p><p className="text-slate-500 font-mono text-[10px] uppercase font-bold tracking-widest mt-1">Craftsmanship Since 1997</p></div>
            </div>
            <div className="flex items-center space-x-4 border-r border-slate-100 last:border-0 pr-8">
              <div className="text-brand-navy p-3 bg-brand-navy/5"><Award size={32} /></div>
              <div><p className="text-brand-dark font-display font-black text-2xl tracking-tighter leading-none uppercase italic">Expert Care</p><p className="text-slate-500 font-mono text-[10px] uppercase font-bold tracking-widest mt-1">Licensed & Insured</p></div>
            </div>
            <div className="flex items-center space-x-4 border-r border-slate-100 last:border-0 pr-8">
              <div className="text-brand-navy p-3 bg-brand-navy/5"><MapPin size={32} /></div>
              <div><p className="text-brand-dark font-display font-black text-2xl tracking-tighter leading-none uppercase italic">Gulf Coast</p><p className="text-slate-500 font-mono text-[10px] uppercase font-bold tracking-widest mt-1">St. Pete down to Ft. Myers</p></div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-brand-navy p-3 bg-brand-navy/5"><ShieldCheck size={32} /></div>
              <div><p className="text-brand-dark font-display font-black text-2xl tracking-tighter leading-none uppercase italic">100% Insured</p><p className="text-slate-500 font-mono text-[10px] uppercase font-bold tracking-widest mt-1">Maximum Liability Coverage</p></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-12 gap-0 border-2 border-brand-navy">
            <div className="lg:col-span-7 p-12 lg:p-24 bg-brand-navy flex flex-col justify-center">
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <div className="border-l border-white/20 pl-6 py-2"><p className="text-brand-orange font-mono text-xs tracking-widest uppercase mb-3 font-bold">01 / Experience</p><p className="text-white text-xl font-display font-bold uppercase">Since 1997</p><p className="text-slate-400 text-sm mt-2">Decades of Gulf Coast construction experience.</p></div>
                <div className="border-l border-white/20 pl-6 py-2"><p className="text-brand-orange font-mono text-xs tracking-widest uppercase mb-3 font-bold">02 / Guarantee</p><p className="text-white text-xl font-display font-bold uppercase">Pay When Thrilled</p><p className="text-slate-400 text-sm mt-2">Zero risk deployment. Final sign-off required.</p></div>
                <div className="border-l border-white/20 pl-6 py-2"><p className="text-brand-orange font-mono text-xs tracking-widest uppercase mb-3 font-bold">03 / Reliability</p><p className="text-white text-xl font-display font-bold uppercase">On-Time Pact</p><p className="text-slate-400 text-sm mt-2">Strict timelines. Documented accuracy.</p></div>
                <div className="border-l border-white/20 pl-6 py-2"><p className="text-brand-orange font-mono text-xs tracking-widest uppercase mb-3 font-bold">04 / Region</p><p className="text-white text-xl font-display font-bold uppercase">Florida Built</p><p className="text-slate-400 text-sm mt-2">Transferable 5-year structural warranty.</p></div>
              </div>
              <div className="mt-16 pt-10 border-t border-white/10">
                <button onClick={() => scrollTo('quote')} className="btn-primary bg-brand-orange text-brand-navy shadow-[4px_4px_0px_rgba(255,255,255,1)]">Verify Qualifications</button>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="relative">
              ...
              <div className="flex items-center space-x-6">
                <div className="w-16 h-16 bg-brand-orange flex items-center justify-center text-brand-navy shadow-[4px_4px_0px_rgba(255,255,255,1)]"><MapPin size={32} /></div>
                <div><p className="text-white font-display font-bold text-2xl uppercase italic tracking-tight">Active Deployment</p><p className="text-brand-orange font-mono text-xs tracking-widest uppercase mt-1">St. Pete &gt;&gt; Ft. Myers</p></div>
              </div>
            </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 grid lg:grid-cols-2 gap-24 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="order-1 lg:order-2">
            ...
            <div className="grid grid-cols-2 gap-8 pt-10 border-t-2 border-brand-navy/5">
              <div><p className="text-brand-navy text-5xl font-display font-black mb-2">1997</p><p className="text-slate-400 font-mono font-bold uppercase text-[10px] tracking-[.3em]">Inception</p></div>
              <div><p className="text-brand-orange text-5xl font-display font-black mb-2">100%</p><p className="text-slate-400 font-mono font-bold uppercase text-[10px] tracking-[.3em]">Mission Success</p></div>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 sm:gap-20 mb-24">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-6 mb-10"><Logo className="h-12 md:h-16" /></div>
              <p className="text-slate-500 text-sm max-w-sm leading-relaxed">NPP Enterprises, LLC provides premium custom homes, remodels, windows, doors, and site prep services across the Florida Gulf Coast since 1997.</p>
